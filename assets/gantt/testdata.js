...
// 		{"id":2, "text":"Task #1", "start_date":"03-04-2018", "duration":"15", "parent":"1", "progress": 1, "open": true, "users": ["John", "Mike"], "priority": "1"},
...
var projects_milestones_critical = {
	data: [
		{ id: 1, text: "Office itinerancy", type: "project", progress: 0.4, open: true, start_date: "01-04-2018 00:00", duration:6, parent: 0 },
		{ id: 2, text: "Office facing", type: "task", start_date: "01-04-2018 00:00", duration: 5, progress: 0.6, parent: 1, open: true},
		{ id: 3, text: "Furniture installation", type: "task",  progress: 0.4, start_date: "03-04-2018 00:00", duration: 4, parent: 1},
		{ id: 4, text: "The employee relocation", type: "task", start_date: "04-04-2018 00:00", duration: 5, parent: 0, progress: 0.5, open: true},
		{ id: 5, text: "Interior office", type: "task", start_date: "05-04-2018 00:00", duration: 8, parent: 0, progress: 0.6, open: true},
		// { id: 6, text: "Air conditioners check", type: "task",  start_date: "06-04-2018 00:00", duration: 2, parent: 0, progress: 0.9, open: true},
		{ id: 7, text: "Workplaces preparation", type: "task",  start_date: "07-04-2018 00:00", duration: 8, parent: 0, progress: 0.6, open: true},
		{ id: 8, text: "Preparing workplaces", type: "project",  start_date: "08-04-2018 00:00", duration: 5, parent: 0, progress: 0.5, open: true},
	    { id: 9, text: "Workplaces importation", type: "task",  start_date: "02-04-2018 00:00", duration: 4, parent: 8, progress: 0.5, open: true},
	    { id: 10, text: "Workplaces exportation", type: "task",  start_date: "03-04-2018 00:00", duration: 6, parent: 8, progress: 0.5, open: true},
		{ id: 11, text: "Product launch", type: "task", progress: 0.6, open: true, start_date: "01-04-2018 00:00", duration: 6, parent: 0 }
		// { id: 12, text: "Perform Initial testing", type: "task",  start_date: "02-04-2018 00:00", duration: 5, parent: 0, progress: 1, open: true},
		// { id: 13, text: "Development", type: "task", start_date: "03-04-2018 00:00", duration: 16, parent: 0, progress: 0.5, open: true},
