    ...
    (e.prototype.onDrop = function (e, n) {
            ...
            i.append("<div class='row'></div>"),
                ...
                o.$modal.find("form").on("submit", function () {
                    var e = i.find("input[name='title']").val(),
                        ...
                        alert(a);
                    return (
                        null !== e && 0 != e.length ? (o.$calendarObj.fullCalendar("renderEvent", { title: e, start: t, end: a, allDay: !1, className: n }, !0), o.$modal.modal("hide")) : alert("You have to give a title to your event"), !1
                    );
                }),
        ...
        (e.prototype.init = function () {
            ...
            var e = new Date(),
                ...
                t = [
                    { title: "Hey!", start: new Date(l.now() + 158e6), className: "bg-purple" },
                    { title: "See John Deo", start: n, end: n, className: "bg-success" },
                    { title: "Meet John Deo", start: new Date(l.now() + 168e6), className: "bg-info" },
                    { title: "Buy a Theme", start: new Date(l.now() + 338e6), className: "bg-primary" },
                ],
                a = this;
            (a.$calendarObj = a.$calendar.fullCalendar({
                ...
                this.$saveCategoryBtn.on("click", function () {
                    ...
                    null !== e &&
                        0 != e.length &&
                        (a.$extEvents.append('<div class="external-event bg-' + n + '" data-class="bg-' + n + '" style="position: relative;"><i class="mdi mdi-checkbox-blank-circle m-r-10 vertical-middle"></i>' + e + "</div>"),
                        a.enableDrag());
                });
        }),
        (l.CalendarApp = new e()),
